...
public Plugin myinfo =
{
	...
	author = "Zombieden, zaCade",
	description = "VScript related to the Stripper",
	version = "1.0.3",
	url = ""
};
...
public void OnMapStart()
{
	...
	if (strcmp(sMapname, "ze_ffvii_mako_reactor_v5_3", false) == 0)
	{
...
{
	if (!g_bRaceEnabled || !g_bRaceAutoBhop || !IsClientInGame(client))
